defmodule EpjsApp.AddressControllerTest do
  ...
  describe "address controller returns json response with valid slam_id" do
    test "GET /patient-address-details/address/get-address?service_user", %{conn: conn} do
      stringified_user = %{slam_id: 123} |> Poison.encode!
      conn = get conn, "http://localhost:4001/patient-address-details/address/get-address?service_user=" <> stringified_user
